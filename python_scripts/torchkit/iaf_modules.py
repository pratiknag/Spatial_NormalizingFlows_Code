...
def get_rank(max_rank, num_out):
    ...
    return rank_out.astype('float32')  # Give ranks for the dimensions 
    

def get_mask_from_ranks(r1, r2):
    return (r2[:, None] >= r1[None, :]).astype('float32') # Binary representation of the true-false statement
...
def get_masks(dim, dh, num_layers, num_outlayers=1, fixed_order=False, derank=1):
